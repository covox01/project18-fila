...
function exit(){
    ...
    tl
        .to("#f-path2", 4, {opacity: .8, drawSVG: "100% 100%", ease: ease})
        TweenMax.to("#f-path2", 2, {strokeWidth: 36, delay: 1})

    tl4 
        .to("#f-path1", 3, {opacity: .8, drawSVG: "100% 100%", ease: ease, delay: .8})
        // .to("#f-path2", 1.8, {opacity: 1, drawSVG: "0% 100%", ease: ease, delay: 2.6}, "sync+=.2")

    tl2
        .to("#i-path", 3, {opacity: .8, drawSVG: "100% 100%", ease: ease, delay: .8})

    tl3
        .to("#la-path", 3, {opacity: .8, drawSVG: "0% 0%", ease: ease, delay: .4})
...
function set(){
    ...
    TweenMax.set("#la-path", {opacity: .7, drawSVG: "0% 0%", onComplete: start})
}
